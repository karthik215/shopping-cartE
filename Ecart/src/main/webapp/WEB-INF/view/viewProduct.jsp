        ...
        <div class="container" ng-app = "cartApp">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <h4>${product.productPrice} <i class="fa fa-inr" aria-hidden="true"></i></h4>
                    ...
                    <p ng-controller="cartCtrl">
                        <a href="<spring:url value="/product/productInventory/${product.productId}"  />" class="btn btn-default">Back</a>
